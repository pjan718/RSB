...
We have a new plugin available which has all of the features of the Multi-level Navigation plugin (and <a href="http://pixopoint.com/products/pixopoint-menu/">PixoPoint Menu plugin</a>) plus a bunch more. Visit the <a href="http://pixopoint.com/pixopoint-menu-plugin-beta-0-8/">beta plugin page</a> for more information.
